...
namespace {
    ...
    {
        const ARCHIVE_FILENAME   = '20240721_clinicaregionaldelsanjorge_1f1db54b6a3ecea22489_20240721205205_archive.zip';
        const ARCHIVE_SIZE       = '749834143';
        const INSTALLER_DIR_NAME = 'dup-installer';
        const PACKAGE_HASH       = '1f1db54-21205205';
        const SECONDARY_PACKAGE_HASH = 'be77b43-21205205';
